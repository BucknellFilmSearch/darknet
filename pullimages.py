...
try:
    ...
    for movie in movies:
        ...
        os.system("find ./images/" + str(movie[0]) + " -maxdepth 1 -name '*.png' -o -name '*.jpg' | ./darknet detector test cfg/coco.data cfg/yolo.2.0.cfg yolo.weights > " + str(movie[0]) + ".txt")
	# find ./images/58464642 -maxdepth 1 -name '*.png' -o -name '*.jpg' | ./darknet detector test cfg/coco.data cfg/yolo.2.0.cfg yolo.weights > 58464642.txt
        print('\tproccessed movie number ' +  str(movie[0]))
